...
class TranslationRepoSpec extends Specification with Fixtures {

  "TranslationRepo" should {
    "write" in new TranslationContext {
      implicit val ctx = context
      val r = TranslationRepo.write(trans1en)
      1 must_== 1
    }
  }
